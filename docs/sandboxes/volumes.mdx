...
microsandbox supports four types of mounts: bind mounts, named volumes, tmpfs, and disk-image volumes. (To mount a filesystem *implemented by your own code* rather than backed by host storage, see [Virtual Mounts](/sandboxes/virtual-mounts).)
